...
The diagram below depicts the architecture to be deployed for Azure Open AI Account. By the way I chose East US as Chat GPT is currently in preview in that region.
![image-center](/assets\images\Blog\2023-04-14\aoi.jpg){: .align-center}
...
2. Fill up the [Request Access Form][form]. It takes a couple of days to get a response back.
3. **If you are an Enterprise customer and you want to make sure the data getting feed to the service is not compromised you can opt out so data is not processed by Microsoft for abuse monitoring by filling up** [this form][abuse]
...
{{mynote}}{: .notice--info}
Important info here around Data Privacy.
